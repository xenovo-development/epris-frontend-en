                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-xl-2 col-auto order-0">
                        <div class="header-logo">
                            <NuxtLink to="/">
                                <img class="dark-logo" src="/images/logo/beige-logo.png" alt="Epris Logo">
                                <img class="light-logo" src="/images/logo/beige-logo.png" alt="Epris Logo">
                            </NuxtLink>
                        </div>
                    </div>
                    <!-- Header Logo End -->
                    ...
                    <!-- Header Right Start -->
                    <div class="col-xl-3 col d-none d-sm-flex justify-content-end order-1 order-xl-2">
